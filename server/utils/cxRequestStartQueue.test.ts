...
it('starts requests at least 150 ms apart', async () => {
  ...
  expect(started[1] - started[0]).toBeGreaterThanOrEqual(140)
  expect(started[2] - started[1]).toBeGreaterThanOrEqual(140)
})
